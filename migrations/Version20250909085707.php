 ...
 */
final class Version20250909085707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD image_type VARCHAR(255) DEFAULT NULL, ADD image_size INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category DROP image_type, DROP image_size');
    }
}
