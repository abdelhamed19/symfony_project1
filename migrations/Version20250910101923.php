 ...
 */
final class Version20250910101923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student CHANGE image image VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student CHANGE image image VARCHAR(255) NOT NULL');
    }
}
